...
bool thread_sleep_time_less (const struct list_elem *a, const struct list_elem *b, void *aux);
...
timer_sleep (int64_t tick) 
{
  ...
  list_insert_ordered (&sleep_list, &thread_current ()->elem, thread_sleep_time_less, NULL);
